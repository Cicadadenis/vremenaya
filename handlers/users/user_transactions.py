                ...
                if pay_amount >= min_input_qiwi:
                    ...
                    if get_payments[4] == "form":
                        ...
                        send_message = f"<b>🆙 Пополнение баланса</b>\n" \
                                       ...
                                       f"🥝 Для пополнения баланса, нажмите на кнопку  Перейти к оплате\n" \
                                       f"💵 Сумма пополнения: {pay_amount}💴\n" \
                                       f"➖➖➖➖➖➖➖➖➖➖➖➖➖\n" \
                        ...
                        send_message = f"<b>🆙 Пополнение баланса</b>\n" \
                                       ...
                                       f"нажмите на кнопку  Перейти к оплате\n" \
                                       f"❗ Обязательно введите комментарий, который указан ниже\n" \
                                       f"➖➖➖➖➖➖➖➖➖➖➖➖➖\n" \
                                       f"🏷 Комментарий: {generate_number_check}\n" \
                                       f"📞 QIWI кошелёк: {get_payments[0]}\n" \
                                       f"💵 Сумма пополнения: {pay_amount}💴\n" \
                                       f"➖➖➖➖➖➖➖➖➖➖➖➖➖\n" \
                                       f"🔄 После оплаты, нажмите на Проверить оплату"
                        ...
                        send_message = f"<b>🆙 Пополнение баланса</b>\n" \
                                       f"➖➖➖➖➖➖➖➖➖➖➖➖➖\n" \
                                       f"🥝 Для пополнения баланса, переведите нужную сумму на указанный кошелёк или " \
                                       f"нажмите на кнопку  Перейти к оплате и укажите комментарий\n" \
                                       f"❗ Обязательно введите комментарий, который указан ниже\n" \
                                       f"➖➖➖➖➖➖➖➖➖➖➖➖➖\n" \
                                       f"🏷 Комментарий: {generate_number_check}\n" \
                                       f"Ⓜ QIWI Никнейм: {get_payments[3]}\n" \
                                       f"💵 Сумма пополнения: {pay_amount}💴\n" \
                                       f"➖➖➖➖➖➖➖➖➖➖➖➖➖\n" \
                                       f"🔄 После оплаты, нажмите на Проверить оплату"
                    ...
                    await message.answer(f"❌ <b>Неверная сумма пополнения</b>\n"
                                         f"▶ Мин. сумма пополнения: {min_input_qiwi} $\n"
        ...
        if pay_status == "PAID":
            ...
            if get_purchase is None:
                ...
                await send_all_admin(f"<b>💰 Пользователь</b> "
                                     ...
                                     f"|{call.from_user.id}) "
                                     f"<b>пополнил баланс на сумму</b> {pay_amount}💴 🥝\n"
                                     f"📃 <b>Чек:</b> +{receipt}")
            else:
